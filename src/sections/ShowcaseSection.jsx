                    ...
                    <div className="first-project-wrapper" ref={project1Ref}>
                        ...
                        <div className='text-content'>
                            ...
                            <div className='mt-4 flex gap-3'>
                                ...
                                <a 
                                    href="https://www.youtube.com/watch?v=ypZPKl7hV2A" 
                                    target="_blank" 
                                    rel="noopener noreferrer"
                                    className='inline-flex items-center gap-2 px-4 py-2 bg-green-600/20 hover:bg-green-600/30 border border-green-500/30 hover:border-green-500/50 rounded-lg transition-all duration-300 hover:scale-105 text-green-300 hover:text-green-200'
                                >
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className='project-list-wrapper overflow-hidden'>
                        <div className='project' ref={project2Ref}>
                            ...
                            <div className='mt-3 flex gap-3'>
                                ...
                                <a 
                                    href="https://prep-bot-navy.vercel.app/sign-in" 
                                    target="_blank" 
                                    rel="noopener noreferrer"
                                    className='inline-flex items-center gap-2 px-3 py-2 bg-green-600/20 hover:bg-green-600/30 border border-green-500/30 hover:border-green-500/50 rounded-lg transition-all duration-300 hover:scale-105 text-green-300 hover:text-green-200 text-sm'
                                >
                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z"/>
                                    </svg>
                        ...
                        <div className='project' ref={project3Ref}>
                            <div className='image-wrapper bg-[#ffe7eb]'>
                                <img src='/images/project3.png' alt='StartPro' />
                            </div>
                            ...
                            <div className='mt-3 flex gap-3'>
                                <a 
                                    href="https://github.com/RupErz/StartProApp" 
                                    target="_blank" 
                                    rel="noopener noreferrer"
                                ...
                                <a 
                                    href="https://start-pro-app.vercel.app/" 
                                    target="_blank" 
                                    rel="noopener noreferrer"
                                    className='inline-flex items-center gap-2 px-3 py-2 bg-green-600/20 hover:bg-green-600/30 border border-green-500/30 hover:border-green-500/50 rounded-lg transition-all duration-300 hover:scale-105 text-green-300 hover:text-green-200 text-sm'
                                >
